...
public class ScreenRecordService extends Service implements SurfaceHolder.Callback {

    private static final String tag_ = ScreenRecordService.class.getSimpleName();
